# ghc
# Autogenerated from man page /usr/lib/jvm/default/man/man1/ghc.1.gz
...
complete -c ghc -o ddump-inlinings -d 'Dump inlining info'
...
complete -c ghc -o fcatch-bottoms -d 'Insert error expressions after bottoming expressions; useful when debugging t…'
...
complete -c ghc -o XHaskell98 -d 'Use the Haskell 2010 language variant'
...
complete -c ghc -o keep-cafs -d 'Do not garbage-collect CAFs (top-level expressions) at runtime'
...
complete -c ghc -o fmax-worker-args -d 'default: 10'
...
complete -c ghc -o funfolding-keeness-factor -d 'default: 1. 5.  Tweak unfolding settings'
complete -c ghc -o funfolding-use-threshold -d 'default: 60.  Tweak unfolding settings'
...
complete -c ghc -o Wspace-after-bang -d 'warn for missing space before the second argument of an infix definition of (…'
...
complete -c ghc -o fno-sort-by-size-hole-fits -o fno-sort-by-subsumption-hole-fits -o Wno-inferred-safe-imports -o Wno-missing-safe-haskell-mode
